...
void FontAwesomeManager::construct(const Construct &options) {
...

  {
...

    {
      ...
      cprinter::CppPrinter::HeaderGuard header_guard(m_code_printer, "FONTAWESOME_ICONS_HPP");
      cprinter::CppPrinter::NamespaceScope icons_namespace(m_code_printer, "icons");
      cprinter::CppPrinter::NamespaceScope bs_namespace(m_code_printer, "fa");
