...
void ComponentManager::generate_header() {
  ...
  m_header_printer.inline_comment("Do not edit this file. It was generated automatically with DesignLab.");
  m_header_printer.inline_comment("Don't try to build this file. Just copy and paste the parts you need to another source file.");
  m_header_printer.newline();
...
void ComponentManager::add_modifiers(json::JsonObject node) {
  ...
  if (class_name == AddComponent::Components::label) {
    const auto label_value = node.at(Fields::component_label_text);
    if (label_value.is_valid()) {
      m_source_printer.line(
