...
private:
  ...
  static constexpr auto component_type_list_design = {
    ...
    ComponentType{ Components::horizontal_line, icons::fa::window_minimize_solid },
  ...
  static constexpr auto component_type_list_extra_design = {
    ...
    ComponentType{ Components::form, icons::fa::tasks_solid },
    ...
    ComponentType{ Components::form_select_file, icons::fa::file_alt_solid },
    ComponentType{ Components::form_switch, icons::fa::toggle_on_solid },
    ComponentType{ Components::notification_toast, icons::fa::exclamation_circle_solid },
